import type { IQuestionStoreData }                   from './types'
import type { TQuestions, TQuestion, TQuestionName } from '~/services/flow'
...
( steps?: TQuestions<TQuestion>, current?: TQuestionName ): Omit<IQuestionStoreData, 'steps'>
{
